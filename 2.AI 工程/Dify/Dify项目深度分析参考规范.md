...
> 详细作图规范已迁入 `7.提示词与AI协作/项目分析与Mermaid Prompt/references`，优先通过通用 Mermaid Prompt 和对应 reference 组合使用，而不是继续依赖旧版 skill 路径。
...
| `7.提示词与AI协作/项目分析与Mermaid Prompt/references` | Mermaid 图表规范定义、风格参考、最佳实践 | ✅ 已迁入 Prompt 资产 |
...
> ✅ 已并入 `7.提示词与AI协作/项目分析与Mermaid Prompt/references`
